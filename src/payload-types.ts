...
export interface Event {
  ...
  /**
   * Auto-generated unique identifier for sharing
   */
  slug?: string | null;
  /**
   * Array of ISO date strings representing available dates
   */
  dateOptions:
    | {
        [k: string]: unknown;
...
export interface EventParticipation {
  ...
  /**
   * Array of ISO date strings the participant selected
   */
  selectedDates:
    | {
        [k: string]: unknown;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        ...
        value: number | EventParticipation;
      } | null);
